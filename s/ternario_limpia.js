...
var Operador = /*#__PURE__*/function () {
  ...
  _createClass(Operador, [{
    ...
    value: function validacion() {
      ...
      var operador_terneario = this.dato > 2 ? "Es mayor a 2" : "Es menor a 2";
      document.write("El numero ".concat(operador_terneario));
      document.write("El numero ".concat(this.dato > 2 ? "Es mayor a 2" : "Es menor a 2"));
